...
class myHash {
    constructor() {
        this.hashSubidasS1 = new Map();
        this.hashLlanosS1 = new Map();
        this.hashBajadasS1 = new Map();
        this.hashSubidasS2 = new Map();
        this.hashLlanosS2 = new Map();
        this.hashBajadasS2 = new Map();
        this.pSubidas = [];
        this.pBajadas = [];
        this.pLlanos = []; // se guardan los porcentajes que han sido usados, esto para evitar entrar al hash
    ...
    guardarEnHash(porcentaje, segundito, hash) {
